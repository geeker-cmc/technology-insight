...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  {
    path: "/technical-tracking",
    component: Layouts,
    redirect: "/technical-tracking/information-tracking",
    ...
    children: [{
      ...
      component: () => import("@/pages/technical-tracking/information-tracking/index.vue"),
      name: "InformationTracking",
      meta: {
        title: "信息跟踪"
      }
    }, {
      path: "report-center",
      component: () => import("@/pages/technical-tracking/report-center/index.vue"),
      name: "ReportCenter",
      meta: {
        title: "报告中心"
      }
  ...
  {
    path: "/technical-scanning",
    component: Layouts,
    name: "TechnicalScanning",
    redirect: "/technical-scanning/report-scanning",
    meta: {
      title: "技术扫描"
    },
    children: [{
      path: "report-scanning",
      component: () => import("@/pages/technical-scanning/report-scanning/index.vue"),
      name: "ReportScanning",
      meta: {
        title: "技术情报扫描"
      }
      ...
      component: () => import("@/pages/technical-scanning/technical-analysis/index.vue"),
  ...
  {
    path: "/technical-judgment",
    component: Layouts,
    name: "TechnicalJudgment",
    redirect: "/technical-judgment/cross-analysis",
    meta: {
      title: "技术研判"
    },
    children: [{
      path: "cross-analysis",
      component: () => import("@/pages/technical-judgment/cross-analysis/index.vue"),
      name: "CrossAnalysis",
      meta: {
        title: "交叉分析"
      }
    }, {
      path: "expert-judgment",
      component: () => import("@/pages/technical-judgment/expert-judgment/index.vue"),
      name: "ExpertJudgment",
      meta: {
        title: "专家研判"
      }
      ...
      component: () => import("@/pages/technical-judgment/special-research/index.vue"),
